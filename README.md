...
- CSS Properties for Texts-Font Roboto

- CSS Dark mode, Light mode (theme)

- CSS buttons, moon color, 

- JS Dom , global storage , local storage

- JS Onclick , calc() , chMode() 

- JS function chMode(), setAttribute, replaced
...
>>Part-1 HTML Structure
	...
	- Create a form (id="calculator")
	

>>Part-2 CSS Structure
	- Set a background and define font-color="white","dark"
